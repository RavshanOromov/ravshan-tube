...
// import { CheckCircle, Tag, Visibility, FavoriteOutlined, MarkChatRead } from '@mui/icons-material'
...
//           <ReactPlayer 
//              url={`https://youtube.com/watch?v=${id}`} className='react-player' controls 
//           />
